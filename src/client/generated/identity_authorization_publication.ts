 ...
 * consumers.
 */
export interface AuthorizationProjectionStore {
  accepted_revision?: number | null;
  manifest?: AuthorizationProjectionManifest | null;
  threads: {
    [k: string]: AuthorizationThreadCapabilitySnapshot;
  };
  workspaces: {
    [k: string]: AuthorizationWorkspaceCapabilitySnapshot;
  };
  [k: string]: unknown;
}
export interface AuthorizationProjectionManifest {
