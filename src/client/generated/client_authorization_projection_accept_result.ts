...
export type AuthorizationProjectionAcceptance = 'accepted' | 'stale' | 'conflict' | 'incompatible';
...
export interface ClientAuthorizationProjectionAcceptResult {
  acceptance: AuthorizationProjectionAcceptance;
  snapshot?: AuthorizationCapabilitySnapshot | null;
}
